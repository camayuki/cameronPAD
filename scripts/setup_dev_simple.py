"""
Simple development setup script - no asyncio
...
"""
    ...
    print("📚 Next steps:")
    print("   1. Install dependencies manually if needed")
    print("   2. Run development server: py scripts/dev_server_simple.py")
